...
3. ** Visual Payload Builder**: An interactive checkbox dashboard to customize injection payload templates (Keep-Alive, Online Host, User-Agent, Referer, Front Query).
